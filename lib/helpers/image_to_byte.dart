...
import 'package:flutter_cache_manager/flutter_cache_manager.dart';
 ...
 Future<Uint8List> imageToBytes({
  ...
  if (rotation != null) {      
    final imageB = await getRotateImageBytes(image, rotation, width: width.toDouble());
...
Future<ui.Image> getRotateImageBytes(ui.Image image, double rotation, {
  ...
  if (width != null) {
    // Calcular el nuevo tamaño de la imagen basado en el ancho proporcionado
    final scale = width / imageSize.width;
    imageSize = Size(width, imageSize.height * scale);
  }
